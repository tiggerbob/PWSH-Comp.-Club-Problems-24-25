...
Given a set of messages, you need to find: <br>
...
## Input Format
The first line contains an integer n (1 ≤ n ≤ 100), the number of messages to decode. <br>
Each of the following n lines contains a string s consisting of only the characters 1 and 0 (1 ≤ |s| ≤ 100), representing a message from the Zyphers. <br>
