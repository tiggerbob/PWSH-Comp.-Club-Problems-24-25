...
?? int c - number of confirmations being claimed, but also hasNextInt() is real so not necessarily needed? - alternatively, num crewmates? 
c lines containing two names, name of someone on the ship and name of who they are claiming to be able to confirm innocent
